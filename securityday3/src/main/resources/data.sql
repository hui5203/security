...
-- --
-- -- -- 初始化userinfo
-- insert into user_info(password,username,uid) value ('1','admin','1')
-- insert into user_info(password,username,uid) value ('1','user','2')
--
--
-- -- 给user配置role
...
-- 初始化user
insert into user_info (password, username, uid) values ('1', 'admin', '1')
insert into user_info (password, username, uid) values ('1', 'user', '2')
insert into user_info (password, username, uid) values ('1', 'user2', '3')
